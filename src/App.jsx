	...
	const toggleTheme = () => {
		...
		setTheme((prevTheme) => {
			...
			if (newTheme === 'dark') {
				...
				root.style.setProperty('--dim-text-color', 'rgb(38, 37, 37)');
				root.style.setProperty('--bright-text-color', 'rgb(76, 74, 74)');
				root.style.setProperty('--main-bg-color', 'rgb(193, 193, 156)');
				root.style.setProperty('--dim-bg-color', 'rgb(152, 152, 104)');
