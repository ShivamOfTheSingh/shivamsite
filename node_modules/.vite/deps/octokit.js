...
if (typeof AC === "undefined") {
  ...
  AC = class AbortController {
    ...
    abort(reason) {
      ...
      (_b = (_a5 = this.signal).onabort) == null ? void 0 : _b.call(_a5, reason);
    }
  };
...
var _LRUCache = class _LRUCache {
  ...
  static unsafeExposeInternals(c) {
    return {
      ...
      isBackgroundFetch: (p) => {
        var _a5;
        return __privateMethod(_a5 = c, _isBackgroundFetch, isBackgroundFetch_fn).call(_a5, p);
      },
      backgroundFetch: (k, index, options, context) => {
        var _a5;
        return __privateMethod(_a5 = c, _backgroundFetch, backgroundFetch_fn).call(_a5, k, index, options, context);
      },
      moveToTail: (index) => {
        var _a5;
        return __privateMethod(_a5 = c, _moveToTail, moveToTail_fn).call(_a5, index);
      },
      indexes: (options) => {
        var _a5;
        return __privateMethod(_a5 = c, _indexes, indexes_fn).call(_a5, options);
      },
      rindexes: (options) => {
        var _a5;
        return __privateMethod(_a5 = c, _rindexes, rindexes_fn).call(_a5, options);
      },
      isStale: (index) => {
        var _a5;
      ...
      if (index !== void 0) {
        ...
        if (__privateGet(this, _size) === 1) {
          ...
          if (__privateMethod(this, _isBackgroundFetch, isBackgroundFetch_fn).call(this, v)) {
            ...
            if (__privateGet(this, _hasDispose)) {
              (_a5 = __privateGet(this, _dispose)) == null ? void 0 : _a5.call(this, v, k, "delete");
            }
            if (__privateGet(this, _hasDisposeAfter)) {
